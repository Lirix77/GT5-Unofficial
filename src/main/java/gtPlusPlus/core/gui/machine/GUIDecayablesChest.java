...
import gtPlusPlus.core.container.ContainerDecayablesChest;
import gtPlusPlus.core.tileentities.general.TileEntityDecayablesChest;

@SideOnly(Side.CLIENT)
public class GUIDecayablesChest extends GuiContainer {

    private static final ResourceLocation craftingTableGuiTextures = new ResourceLocation(
        GTPlusPlus.ID,
        "textures/gui/FishTrap.png");

    public GUIDecayablesChest(final InventoryPlayer player_inventory, final TileEntityDecayablesChest te) {
        super(new ContainerDecayablesChest(player_inventory, te));
    }
