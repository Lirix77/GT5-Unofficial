...
public class ContainerDecayablesChest extends Container {

    protected TileEntityDecayablesChest tile_entity;
    public final InventoryDecayablesChest inventoryChest;
    ...
    public ContainerDecayablesChest(final InventoryPlayer inventory, final TileEntityDecayablesChest te) {
        this.tile_entity = te;
