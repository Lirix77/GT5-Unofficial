...
public enum DimensionDef {
    ...
    Pluto(new ModDimensionDef(
        DimNames.PLUTO,
        "galaxyspace.systems.SolarSystem.planets.pluto.dimension.ChunkProviderPluto",
        Enums.DimensionType.Planet,
        DimensionBlockMetaDefinitionList.Pluto.DBMDefList)),
    Triton(new ModDimensionDef(
        DimNames.TRITON,
        "galaxyspace.systems.SolarSystem.moons.triton.dimension.ChunkProviderTriton",
        Enums.DimensionType.Planet,
        DimensionBlockMetaDefinitionList.Triton.DBMDefList)),
    Proteus(new ModDimensionDef(
        DimNames.PROTEUS,
        "galaxyspace.systems.SolarSystem.moons.proteus.dimension.ChunkProviderProteus",
        Enums.DimensionType.Planet,
        DimensionBlockMetaDefinitionList.Proteus.DBMDefList)),
    Oberon(new ModDimensionDef(
        DimNames.OBERON,
        "galaxyspace.systems.SolarSystem.moons.oberon.dimension.ChunkProviderOberon",
        Enums.DimensionType.Planet,
        DimensionBlockMetaDefinitionList.Oberon.DBMDefList)),
    Titan(new ModDimensionDef(
        DimNames.TITAN,
        "galaxyspace.systems.SolarSystem.moons.titan.dimension.ChunkProviderTitan",
        Enums.DimensionType.Planet,
        DimensionBlockMetaDefinitionList.Titan.DBMDefList)),
    Callisto(new ModDimensionDef(
        DimNames.CALLISTO,
        "galaxyspace.systems.SolarSystem.moons.callisto.dimension.ChunkProviderCallisto",
        Enums.DimensionType.Planet,
        DimensionBlockMetaDefinitionList.Callisto.DBMDefList)),
    Ganymede(new ModDimensionDef(
        DimNames.GANYMEDE,
        "galaxyspace.systems.SolarSystem.moons.ganymede.dimension.ChunkProviderGanymede",
        Enums.DimensionType.Planet,
        DimensionBlockMetaDefinitionList.Ganymede.DBMDefList)),
    Ceres(new ModDimensionDef(
        DimNames.CERES,
        "galaxyspace.systems.SolarSystem.planets.ceres.dimension.ChunkProviderCeres",
        Enums.DimensionType.Planet,
        DimensionBlockMetaDefinitionList.Ceres.DBMDefList)),
    Deimos(new ModDimensionDef(
        DimNames.DEIMOS,
        "galaxyspace.systems.SolarSystem.moons.deimos.dimension.ChunkProviderDeimos",
        Enums.DimensionType.Planet,
        DimensionBlockMetaDefinitionList.Deimos.DBMDefList)),
    Enceladus(new ModDimensionDef(
        DimNames.ENCELADUS,
        "galaxyspace.systems.SolarSystem.moons.enceladus.dimension.ChunkProviderEnceladus",
        Enums.DimensionType.Planet,
        DimensionBlockMetaDefinitionList.Enceladus.DBMDefList)),
    Io(new ModDimensionDef(
        DimNames.IO,
        "galaxyspace.systems.SolarSystem.moons.io.dimension.ChunkProviderIo",
        Enums.DimensionType.Planet,
        DimensionBlockMetaDefinitionList.Io.DBMDefList)),
    Europa(new ModDimensionDef(
        DimNames.EUROPA,
        "galaxyspace.systems.SolarSystem.moons.europa.dimension.ChunkProviderEuropa",
        Enums.DimensionType.Planet,
        DimensionBlockMetaDefinitionList.Europa.DBMDefList)),
    Phobos(new ModDimensionDef(
        DimNames.PHOBOS,
        "galaxyspace.systems.SolarSystem.moons.phobos.dimension.ChunkProviderPhobos",
        Enums.DimensionType.Planet,
        DimensionBlockMetaDefinitionList.Phobos.DBMDefList)),
    Venus(new ModDimensionDef(
        DimNames.VENUS,
        "galaxyspace.systems.SolarSystem.planets.venus.dimension.ChunkProviderVenus",
        Enums.DimensionType.Planet,
        DimensionBlockMetaDefinitionList.Venus.DBMDefList)),
    Mercury(new ModDimensionDef(
        DimNames.MERCURY,
        "galaxyspace.systems.SolarSystem.planets.mercury.dimension.ChunkProviderMercury",
        Enums.DimensionType.Planet,
        DimensionBlockMetaDefinitionList.Mercury.DBMDefList)),
    MakeMake(new ModDimensionDef(
        DimNames.MAKEMAKE,
        "galaxyspace.systems.SolarSystem.planets.makemake.dimension.ChunkProviderMakemake",
        Enums.DimensionType.Planet,
        DimensionBlockMetaDefinitionList.MakeMake.DBMDefList)),
    Haumea(new ModDimensionDef(
        DimNames.HAUMEA,
        "galaxyspace.systems.SolarSystem.planets.haumea.dimension.ChunkProviderHaumea",
        Enums.DimensionType.Planet,
        DimensionBlockMetaDefinitionList.Haumea.DBMDefList)),
    CentauriAlpha(new ModDimensionDef(
        DimNames.CENTAURIA,
        "galaxyspace.systems.ACentauriSystem.planets.aCentauriBb.dimension.ChunkProviderACentauri",
        Enums.DimensionType.Planet,
        DimensionBlockMetaDefinitionList.CentauriAlpha.DBMDefList)),
    VegaB(new ModDimensionDef(
        DimNames.VEGAB,
        "galaxyspace.systems.VegaSystem.planets.vegaB.dimension.ChunkProviderVegaB",
        Enums.DimensionType.Planet,
        DimensionBlockMetaDefinitionList.VegaB.DBMDefList)),
    BarnardC(new ModDimensionDef(
        DimNames.BARNARDC,
        "galaxyspace.systems.BarnardsSystem.planets.barnardaC.dimension.ChunkProviderBarnardaC",
        Enums.DimensionType.Planet,
        DimensionBlockMetaDefinitionList.BarnardaC.DBMDefList)),
    BarnardE(new ModDimensionDef(
        DimNames.BARNARDE,
        "galaxyspace.systems.BarnardsSystem.planets.barnardaE.dimension.ChunkProviderBarnardaE",
        Enums.DimensionType.Planet,
        DimensionBlockMetaDefinitionList.BarnardaE.DBMDefList)),
    BarnardF(new ModDimensionDef(
        DimNames.BARNARDF,
        "galaxyspace.systems.BarnardsSystem.planets.barnardaF.dimension.ChunkProviderBarnardaF",
        Enums.DimensionType.Planet,
        DimensionBlockMetaDefinitionList.BarnardaF.DBMDefList)),
    TcetiE(new ModDimensionDef(
        DimNames.TCETIE,
        "galaxyspace.systems.TCetiSystem.planets.tcetiE.dimension.ChunkProviderTCetiE",
        Enums.DimensionType.Planet,
        DimensionBlockMetaDefinitionList.TcetiE.DBMDefList)),
    Miranda(new ModDimensionDef(
        DimNames.MIRANDA,
        "galaxyspace.systems.SolarSystem.moons.miranda.dimension.ChunkProviderMiranda",
        Enums.DimensionType.Planet,
        DimensionBlockMetaDefinitionList.Miranda.DBMDefList)),
    KuiperBelt(new ModDimensionDef(
        DimNames.KUIPERBELT,
        "galaxyspace.systems.SolarSystem.planets.kuiperbelt.dimension.ChunkProviderKuiper",
        Enums.DimensionType.Asteroid)),
