...
public class ItemComb extends Item implements IGT_ItemWithMaterialRenderer {
    ...
    public void initCombsRecipes() {
        ...
        addCentrifugeToItemStack(
            CombType.CRYOTHEUM,
            new ItemStack[] { Materials.Cryotheum.getDust(1) },
            new int[] { 100 * 100 },
            Voltage.MV);
        addCentrifugeToItemStack(
            CombType.BLIZZ,
            new ItemStack[] { Materials.Blizz.getDust(1) },
            new int[] { 100 * 100 },
            Voltage.MV);
        // Alloy
