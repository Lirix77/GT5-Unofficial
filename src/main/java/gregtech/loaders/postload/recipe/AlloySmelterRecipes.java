...
public class AlloySmelterRecipes implements Runnable {
    ...
    public void run() {
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemOutputs(ItemList.AluminoSilicateWool.get(2L)).duration(60 * SECONDS).eut(15)
        ...
        GT_Values.RA.stdBuilder().itemInputs(new ItemStack(Blocks.obsidian, 1, 0), ItemList.Shape_Mold_Ingot.get(0L))
            ...
            .duration(6 * SECONDS + 10 * TICKS).eut(3).addTo(sAlloySmelterRecipes);

        GT_Values.RA.stdBuilder()
            .itemInputs(
                GT_ModHandler.getModItem(IndustrialCraft2.ID, "itemPartIridium", 2L),
                ItemList.Shape_Mold_Casing.get(0))
            .itemOutputs(ItemList.IridiumAlloyItemCasing.get(3))
            .duration(60 * SECONDS).eut(256).addTo(sAlloySmelterRecipes);
        ...
        if (EnderIO.isModLoaded()) {
            ...
            GT_Values.RA.stdBuilder().itemInputs(Materials.CertusQuartz.getDust(2), Materials.Glass.getDust(1))
                ...
                .eut(TierEU.RECIPE_LV).addTo(sAlloySmelterRecipes);
            ...
            GT_Values.RA.stdBuilder()
                ...
                .itemOutputs(GT_ModHandler.getModItem(EnderIO.ID, "blockFusedQuartz", 1L)).duration(25 * SECONDS)
                .eut(90).addTo(sAlloySmelterRecipes);
            ...
            for (int i = 0; i < OreDictionary.getOres("dyeBlack").size(); i++) {
                ...
                GT_Values.RA.stdBuilder()
                    ...
                    .duration(25 * SECONDS).eut(TierEU.RECIPE_LV).addTo(sAlloySmelterRecipes);
        ...
        if (TinkerConstruct.isModLoaded()) {
            GT_Values.RA.stdBuilder()
                ...
                .duration(5 * SECONDS).eut(TierEU.RECIPE_MV).addTo(sAlloySmelterRecipes);
