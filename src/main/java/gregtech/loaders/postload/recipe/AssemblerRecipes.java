...
public class AssemblerRecipes implements Runnable {
    ...
    public void run() {
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemOutputs(ItemList.SteelBars.get(4L)).duration(20 * SECONDS).eut(48).addTo(assemblerRecipes);
        ...
        if (ExtraUtilities.isModLoaded()) {
            ...
            GT_Values.RA.stdBuilder()
                ...
                .duration(TICKS).eut(TierEU.RECIPE_ZPM).addTo(assemblerRecipes);
    ...
    private void makeCircuitPartRecipes() {
        ...
        GT_Values.RA.stdBuilder()
            ...
            .duration(MINUTES + 20 * SECONDS).eut(8).addTo(assemblerRecipes);
