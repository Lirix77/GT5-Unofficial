...
public class CircuitAssemblerRecipes implements Runnable {
    ...
    public final ItemStack[] RocketChip = new ItemStack[] { ItemList.SchematicsTier1.get(1L),
        ItemList.SchematicsTier2.get(1L), ItemList.SchematicsTier3.get(1L) };
    ...
    public final ItemStack[] ExtraChips = new ItemStack[] { ItemList.SchematicsMoonBuggy.get(1L),
        ItemList.SchematicsCargoRocket.get(1L), ItemList.SchematicsAstroMiner.get(1L) };
        ...
        if (AppliedEnergistics2.isModLoaded()) {
            ...
            GT_Values.RA.stdBuilder()
                .itemInputs(
                    ...
                    ItemList.ChargedCertusQuartzDust.get(2),
                    ItemList.LogicProcessorItemGoldCore.get(1),
            ...
            GT_Values.RA.stdBuilder()
                .itemInputs(
                    ...
                    ItemList.EngineeringProcessorItemDiamondCore.get(1),
