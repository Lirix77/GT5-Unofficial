    ...
    public void run() {
...

        {
            ...
            if (GTPlusPlus.isModLoaded()) {
                ...
                GT_Values.RA.stdBuilder().fluidInputs(
                        MaterialsCubix.RadoxPolymer.getMolten(4L * tier_1_quantity / 25),
                ...
                GT_Values.RA.stdBuilder().fluidInputs(
                        MaterialsCubix.RadoxPolymer.getMolten(4L * tier_2_quantity / 25),
                ...
                GT_Values.RA.stdBuilder().fluidInputs(
                        MaterialsCubix.RadoxPolymer.getMolten(4L * tier_3_quantity / 25),
