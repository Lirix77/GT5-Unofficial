...
public class GTPacketSetConfigurationCircuit extends GTPacket {
    ...
    public GTPacketSetConfigurationCircuit(IGregTechTileEntity tile, int circuit) {
        this(tile.getXCoord(), tile.getYCoord(), tile.getZCoord(), circuit);
    }

    public GTPacketSetConfigurationCircuit(BaseTileEntity tile, int circuit) {
        this(tile.getXCoord(), tile.getYCoord(), tile.getZCoord(), circuit);
    }

    public GTPacketSetConfigurationCircuit(int x, short y, int z, int circuit) {
        super();
    ...
    public void process(IBlockAccess aWorld) {
        ...
        machine.getConfigurationCircuits()
            .stream()
            .filter(stack -> GTUtility.areStacksEqual(stack, GTUtility.getIntegratedCircuit(circuit)))
            .findFirst()
