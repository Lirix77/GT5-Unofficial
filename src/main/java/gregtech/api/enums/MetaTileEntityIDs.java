...
public enum MetaTileEntityIDs {
    ...
    ALLOY_SMELTER_LuV(206),
    ALLOY_SMELTER_ZPM(207),
    ALLOY_SMELTER_UV(208),
    WIRELESS_HATCH_ENERGY_ULV(10760),
    WIRELESS_HATCH_ENERGY_LV(10761),
    WIRELESS_HATCH_ENERGY_MV(10762),
    WIRELESS_HATCH_ENERGY_HV(10763),
    ASSEMBLER_LV(211),
    ASSEMBLER_MV(212),
    ASSEMBLER_HV(213),
    ASSEMBLER_EV(214),
    ASSEMBLER_IV(215),
    WIRELESS_HATCH_ENERGY_EV(10764),
    WIRELESS_HATCH_ENERGY_IV(10765),
    WIRELESS_HATCH_ENERGY_LuV(10766),
    WIRELESS_HATCH_ENERGY_ZPM(10767),
    BENDING_MACHINE_LV(221),
    BENDING_MACHINE_MV(222),
    BENDING_MACHINE_HV(223),
    BENDING_MACHINE_EV(224),
    BENDING_MACHINE_IV(225),
    WIRELESS_HATCH_ENERGY_UV(10768),
    WIRELESS_HATCH_ENERGY_UHV(10769),
    CANNER_LV(231),
    CANNER_MV(232),
    CANNER_HV(233),
    CANNER_EV(234),
    ...
    WIRELESS_HATCH_ENERGY_UEV(10770),
    WIRELESS_HATCH_ENERGY_UIV(10771),
    WIRELESS_HATCH_ENERGY_UMV(10772),
    WIRELESS_HATCH_ENERGY_UXV(10773),
    EXTRACTOR_LV(271),
    EXTRACTOR_MV(272),
    EXTRACTOR_HV(273),
    EXTRACTOR_EV(274),
    ...
    EXTRUDER_EV(284),
    EXTRUDER_IV(285),
    WIRELESS_HATCH_ENERGY_MAX(10774),
    WIRELESS_DYNAMO_ENERGY_HATCH_ULV(10775),
    WIRELESS_DYNAMO_ENERGY_HATCH_LV(10776),
    WIRELESS_DYNAMO_ENERGY_HATCH_MV(10777),
    LATHE_LV(291),
    LATHE_MV(292),
    LATHE_HV(293),
    LATHE_EV(294),
    LATHE_IV(295),
    WIRELESS_DYNAMO_ENERGY_HATCH_HV(10778),
    WIRELESS_DYNAMO_ENERGY_HATCH_EV(10779),
    WIRELESS_DYNAMO_ENERGY_HATCH_IV(10780),
    WIRELESS_DYNAMO_ENERGY_HATCH_LuV(10781),
    MACERATOR_LV(301),
    MACERATOR_MV(302),
    MACERATOR_HV(303),
    MACERATOR_EV(304),
    MACERATOR_IV(305),
    WIRELESS_DYNAMO_ENERGY_HATCH_ZPM(10782),
    MICROWAVE_OVEN_LV(311),
    MICROWAVE_OVEN_MV(312),
    MICROWAVE_OVEN_HV(313),
    MICROWAVE_OVEN_EV(314),
    MICROWAVE_OVEN_IV(315),
    WIRELESS_DYNAMO_ENERGY_HATCH_UV(10783),
    WIRELESS_DYNAMO_ENERGY_HATCH_UHV(10784),
    WIRELESS_DYNAMO_ENERGY_HATCH_UEV(10785),
    WIRELESS_DYNAMO_ENERGY_HATCH_UIV(10786),
    PRINTER_LV(321),
    PRINTER_MV(322),
    PRINTER_HV(323),
    PRINTER_EV(324),
    ...
    SCANNER_EV(344),
    SCANNER_IV(345),
    WIRELESS_DYNAMO_ENERGY_HATCH_UMV(10787),
    WIRELESS_DYNAMO_ENERGY_HATCH_UXV(10788),
    WIRELESS_DYNAMO_ENERGY_HATCH_MAX(10789),
