...
public enum OreMixes {
    ...
    Gold(new OreMixBuilder().name("ore.mix.gold")
        ...
        .size(32)
        .enableInDim(OW)
        .enableInDim(EndAsteroids, Seth, Asteroids, Mars)
        .primary(Materials.Magnetite)
        .secondary(Materials.Magnetite)
    ...
    Cassiterite(new OreMixBuilder().name("ore.mix.cassiterite")
        ...
        .density(4)
        .size(24)
        .enableInDim(EndAsteroids, MehenBelt, Seth, Moon)
        .enableInDim(OW)
    ...
    Tetrahedrite(new OreMixBuilder().name("ore.mix.tetrahedrite")
        ...
        .size(24)
        .enableInDim(NETHER)
        .enableInDim(EndAsteroids, Asteroids, Mars)
    ...
    Olivine(new OreMixBuilder().name("ore.mix.olivine")
        ...
        .size(16)
        .enableInDim(OW)
        .enableInDim(EndAsteroids, Anubis, MehenBelt)
    ...
    Lapis(new OreMixBuilder().name("ore.mix.lapis")
        ...
        .size(16)
        .enableInDim(OW)
        .enableInDim(EndAsteroids, MehenBelt)
    ...
    Beryllium(new OreMixBuilder().name("ore.mix.beryllium")
        ...
        .density(2)
        .size(16)
        .enableInDim(OreMixBuilder.NETHER)
        .enableInDim(EndAsteroids, Mars)
    ...
    AquaIgnis(new OreMixBuilder().name("ore.mix.aquaignis")
        ...
        .density(2)
        .size(16)
        .enableInDim(Neper.modDimensionDef.getDimensionName(), NETHER)
    ...
    TitaniumChrome(new OreMixBuilder().name("ore.mix.titaniumchrome")
        ...
        .density(2)
        .size(16)
        .enableInDim(MehenBelt, Moon, Asteroids)
