...
public enum OreMixes {
    ...
    InfusedGold(new OreMixBuilder().name("ore.mix.infusedgold")
        ...
        .density(2)
        .size(16)
        .enableInDim(BarnardE, Haumea, Io, Proteus, Titan, VegaB, Anubis)
    ...
    UraniumGTNH(new OreMixBuilder().name("ore.mix.uraniumgtnh")
        ...
        .density(2)
        .size(24)
        .enableInDim(BarnardE, BarnardF, Haumea, Pluto, Triton, VegaB, Seth)
    ...
    RareEarth(new OreMixBuilder().name("ore.mix.rareearth")
        ...
        .density(2)
        .size(24)
        .enableInDim(BarnardE, BarnardF, CentauriAlpha, VegaB, Neper)
